...
Focused tests run after the audit, anchor-support shadow cleanup, weak-neutral highlight cleanup, saturated-shadow denoise relaxation, shadow-heavy midtone lift, tightened shadow guard, and model-review neutral cleanup:
